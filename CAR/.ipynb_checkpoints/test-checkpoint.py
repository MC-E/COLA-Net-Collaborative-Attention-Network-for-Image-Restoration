...
parser.add_argument('--mode', default='E',help='mode name')
parser.add_argument("--logdir", type=str, default="checkpoints/res_cola_v2_6_3_40_d300/model/model_best.pt", help='path of log files')
...
parser.add_argument("--lr_data",type=str,default="classic5/lr_40")
parser.add_argument("--save_path",type=str,default='res')
parser.add_argument("--rgb_range",type=int,default=1.)
parser.add_argument('--save_res',default=False)
